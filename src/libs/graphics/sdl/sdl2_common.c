...
TFB_PreInit (void)
{
	...
	if (SDL_GameControllerAddMappingsFromFile("/storage/emulated/0/alpha3/uqm/gamecontrollerdb.txt") == -1)
	{
		log_add(log_Warning, "Could not load game controller mappings: %s", SDL_GetError());
	}
#endif
